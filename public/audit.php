...
<body class="subpage-background">
  <div data-collapse="medium" data-animation="default" data-duration="400" role="banner" class="nav-bar w-nav">
    <div class="container w-container"><a href="index.php" class="brand-link w-nav-brand"><img src="images/playlistPlanetStandaloneLogo.png" width="52" srcset="images/playlistPlanetStandaloneLogo-p-500.png 500w, images/playlistPlanetStandaloneLogo.png 800w" sizes="52px" alt="" class="logo"></a>
      <nav role="navigation" class="nav-menu w-nav-menu"><a href="host.php" class="nav-link w-nav-link">hosts</a><a href="shows.php" class="nav-link w-nav-link">Shows</a><a href="episodes.php" class="nav-link w-nav-link">Episodes</a><a href="media.php" class="nav-link w-nav-link">Media</a><a href="artists.php" class="nav-link w-nav-link">Artists</a><a href="libraries.php" class="nav-link w-nav-link">Libraries</a><a href="studios.php" class="nav-link w-nav-link">Studios</a><a href="audit.php" aria-current="page" class="nav-link w-nav-link w--current">Audit</a><a href="functionality.php" class="nav-link w-nav-link">Other Tools</a></nav>
    </div>
  </div>
  <div class="div-block">
    <div data-duration-in="300" data-duration-out="100" class="tabs w-tabs">
      <div class="tabs-menu w-tab-menu">
        <a data-w-tab="BizHack" data-w-id="8b4bcee3-a700-edf0-dffc-7f26eb5a0194" class="tab-link-bizhack-3 w-inline-block w-tab-link w--current">
          <div class="text-block-3">Analysis of episode content</div>
        </a>
      </div>
